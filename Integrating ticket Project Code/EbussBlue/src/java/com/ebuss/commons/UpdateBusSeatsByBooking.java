 ...
 * @author Ramu
 */
public class UpdateBusSeatsByBooking {
    int no=0;
    int trainno=0;
  public int upadteSeats(String serviceNumber,int passngers,java.sql.Date dateofjopurney){
  String query = "select max(available) from busseats where serviceno=? and dates=?";
  ...
  String upadteQuery = "update busseats set available=? where serviceno=? and dates=?";
 ...
 return 0;
  ...
  public int upadteBusSeatsMultiple(String serviceNumber,int passngers,java.sql.Date dateofjopurney){
