 ...
 * @author Ramu
 */
public class InsertTrainRoots {
    PreparedStatement ps2=null;
      String insertQuery="insert into trainseats values(?,?,?,?,?,?,?,?,?)";
         
  public int addTrainRoots(String currentDate,String trainno,String trainname,String sourcecity,String destinationcity,float distance,float cost,int totalSeat,int availableSeat)throws Exception{
 int no=0;
