...
<div id="tooplate_wrapper">
    ...
    <div id="tooplate_main">
        ...
        <div id="tooplate_content">
            <h3>Enter Your Ticjet Number here to find your journey</h3>
            <form method="Post" name="findtrains" action="FindBookingHistory.jsp" onsubmit="return(regvalidate())">
        	<div class="col_w880 home_intro">
            	...
            	<p>
                    ...
                    <input type="text" placeholder="Ticket Number" name="ticketNumber" style="border: solid 1px #707070;box-shadow: 0 0 5px 1px #969696;width: 200px;height: 30px;font-weight: bolder;font-size: 17px"/>
                  
                        
                  <input type="submit" value="Find History" name="submit" style="border: solid 1px #707070;box-shadow: 0 0 5px 1px #969696;width: 200px;height: 30px;font-weight: bolder;font-size: 17px"/>
                 </p>
