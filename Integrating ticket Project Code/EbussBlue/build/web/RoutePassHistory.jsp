...
<div id="tooplate_wrapper">
    ...
    <div id="tooplate_main">
        ...
        <div id="tooplate_content">
            <h3>Enter Pass ID her to Get your Pass Status</h3>
            <form method="Post" name="findtrains" action="FindRoutePassHistory.jsp" onsubmit="return(regvalidate())">
        	<div class="col_w880 home_intro">
            	...
            	<p>
                    ...
                    <input type="text" placeholder="Route Pass ID" name="passID" style="border: solid 1px #707070;box-shadow: 0 0 5px 1px #969696;width: 200px;height: 30px;font-weight: bolder;font-size: 17px"/>
