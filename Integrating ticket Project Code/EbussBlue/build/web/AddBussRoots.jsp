					...
					<ul>
						...
						<li>
							<a href="ViewTrainTicketsBookingHistory.jsp"> Train Tickets</a>
                                            ...
                                            <li>
							<a href="ViewPassData.jsp"> View Pass</a>
						</li>
			...
			<div id="main">
				<div id="content">
                    ...
                    com.ebuss.commons.GenerateBusServiceNo bsn = new com.ebuss.commons.GenerateBusServiceNo();
                      ...
                      String bsid="CAUS0"+no;                                               
%>
                                                                        <td>Service NO</td>
                                                                        <td><input type="text" value="<%=bsid%>" readonly name="serviceno"/> </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>Bus Name</td>
  ...
  <%
       ...
       {
        out.println("<font color='red'><blink>Adding Buss Root Details is Success!</blink></font>");
	}
       else if(message!=null && message.equalsIgnoreCase("faild")){
       out.println("<font color='red'><blink>Adding Buss Root Details is faild!</blink></font>");
       }
       %>
                                                                </table>
                                                                    </tabindex>
