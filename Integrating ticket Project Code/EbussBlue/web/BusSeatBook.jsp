...
int childs = Integer.parseInt(children);
 int AdultType =Integer.parseInt(adults);
          ...
          int noOfPassenger =AdultType+seniorPerson2+Integer.parseInt(children);
%>
      ...
      <div class="col_w880">
          <div style="border-style: solid;border-width: 5px">
              ...
              <%java.sql.Date bookingDate = new java.sql.Date(new java.util.Date().getTime()); %>
                 <form action="BusSeatBookDetails.jsp" method="Post">
...
<br/><br/>
         ...
         for(int j=1;j<=seniorPerson;j++){
          ...
          <label style="border: solid 1px #707070;box-shadow: 0 0 5px 1px #969696;width: 200px;height: 30px;font-weight: bolder;font-size: 17px">Senior Citizen Cost:&nbsp;&nbsp;<%=seniorCitizeCost%></label><br/><br/>
