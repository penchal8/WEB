...
<%
    ...
    ResultSet rs = null;
    String getTrainInfoQuery ="select ticketnumber,no_of_passenger,user_id,service_name,boardingpoint,destination,dateof_journey,TotalTicketFare from busticketmultipleusers";
    try{
