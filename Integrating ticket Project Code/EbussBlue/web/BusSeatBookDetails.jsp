...
<%
com.ebuss.commons.GenerateBusTicket gbt = new com.ebuss.commons.GenerateBusTicket();
com.ebuss.commons.UpdateBusSeatsByBooking ubbb = new com.ebuss.commons.UpdateBusSeatsByBooking();
com.ebuss.commons.BusSeatConfirmation bsc = new com.ebuss.commons.BusSeatConfirmation();
...
String single_person_query = "insert into bussticketsingleperson values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
try{
...
String multiple_person_query = "insert into busticketmultipleusers values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
