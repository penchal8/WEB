...
<form method="post" name="payment" action="ConfirmTrainSeatMultiplePerson.jsp">
...
<div style="font-size: 20px;color: red;font-weight: bolder" color="Red" id="errors"></div>
                    ...
                    <br/><br/>
                    Expiry Date: &nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" maxlength="12" placeholder="mm" name="month" style="border: solid 1px #707070;box-shadow: 0 0 5px 1px #969696;width: 70px;height: 30px;font-weight: bolder;font-size: 17px"/>
