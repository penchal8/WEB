...
<SCRIPT type="Text/JavaScript"> 
    function regvalidate() { 
        var days = GetDays();
      //  alert("Days:"+days);
        var adult=document.findtrains.passtype.value;
       ...
       if(days>60){
        ...
        if((adult=="0")||(document.findtrains.passtype.value==""))   
        {   
            document.getElementById('errors').innerHTML = "Please Select Pass Type ";   
            findtrains.passtype.focus();   
            return(false);  
        } 
...
<div id="tooplate_wrapper">
    ...
    <div id="tooplate_main">
        ...
        <div id="tooplate_content">
            <form method="Post" name="findtrains" action="RootPassFind.jsp" onsubmit="return(regvalidate())">
        	<div class="col_w880 home_intro">
            	...
            	<p>
                    <em>
                        ...
                        You Can Give the Your Information here    &nbsp;&nbsp;&nbsp;<font color="2514e3"><b>Depart Date</b></font><br/>
                    </em> 
                  ...
                  <br/><br/>
                    <select name="passtype" style="border: solid 1px #707070;box-shadow: 0 0 5px 1px #969696;width: 200px;height: 30px;font-weight: bolder;font-size: 17px">
                        <option style="border: solid 1px #707070;box-shadow: 0 0 5px 1px #969696;width: 200px;height: 30px;font-weight: bolder;font-size: 17px" value="0">--Select Pass Type--</option>
                        <option style="border: solid 1px #707070;box-shadow: 0 0 5px 1px #969696;width: 200px;height: 30px;font-weight: bolder;font-size: 17px" value="1">day</option>
                        <option style="border: solid 1px #707070;box-shadow: 0 0 5px 1px #969696;width: 200px;height: 30px;font-weight: bolder;font-size: 17px" value="7">weekly Pass</option>
                        <option style="border: solid 1px #707070;box-shadow: 0 0 5px 1px #969696;width: 200px;height: 30px;font-weight: bolder;font-size: 17px" value="30">monthly</option>
                    </select>   
                 <%String role =(String)session.getAttribute("role");%>
                  
                 &nbsp;<input type="text" value="<%=role%>" readonly name="userType" style="border: solid 1px #707070;box-shadow: 0 0 5px 1px #969696;width: 200px;height: 30px;font-weight: bolder;font-size: 17px"/>
                        
                  <input type="submit" value="Find Root" name="submit" style="border: solid 1px #707070;box-shadow: 0 0 5px 1px #969696;width: 200px;height: 30px;font-weight: bolder;font-size: 17px"/>
                 </p>
