...
%>
    <p>
        <form action="FoodBookStore.jsp" method="post">
            <input type="hidden" name="ticketno" value="<%=ticketNo%>">
            <input type="hidden" name="user" value="<%=user%>">    
            <table>
                <tr>Please Order how many quantity of break fast,lunch and dinner you required at the traveling time, If you leave empty any filed that mean you don't required </tr>
                <tr>
                    <td>Break Fast</td>
                    <td><input type="number" min="1" required name="breakfast"> </td>
                </tr>
                <tr>
                    <td>Lunch</td>
                    <td><input type="number" min="1" name="lunch"> </td>
                </tr>
                <tr>
                    <td>Dinner</td>
                    <td><input type="number"  min="1" name="dinner"> </td>
                </tr>
 ...
 String message=request.getParameter("msg");
       ...
       {
        out.println("<font color='red'><blink>Adding Food Details Success</blink></font>");
	}
       else if(message!=null && message.equalsIgnoreCase("faild")){
       out.println("<font color='red'><blink>you already Order the Food Details</blink></font>");
       }                
%>
            </table>
        </form>
